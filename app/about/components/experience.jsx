...
const experiences = [
	{
		...
		location: "On-Site",
		description:
			"Integrated AI features — including speech-to-text, NLP, and RAG (Retrieval-Augmented Generation) — into client-facing applications. Built and maintained full-stack web applications with scalable REST APIs and RAG-based information retrieval.",
		skills: ["AI Integration", "Speech-to-Text", "NLP", "RAG", "REST APIs", "Full-Stack Development"],
	},
	{
		id: 2,
		startDate: "Oct 2025",
		...
		location: "Remote",
		description:
			"Built scalable, reusable frontend components using React, Next.js, and Tailwind CSS across multiple product modules. Supported technical documentation and UI testing, contributing to consistent quality across modules. Gained hands-on experience with real-world project deployment, debugging, and release workflows.",
		skills: ["React", "Next.js", "Tailwind CSS", "UI Testing", "Technical Documentation"],
	},
	{
		id: 3,
		startDate: "Oct 2024",
		endDate: "Aug 2025",
		company: "DataLinks.ai",
		position: "Full Stack Developer",
		type: "Freelance",
		location: "Remote",
		description:
			"Built and shipped multiple full-stack web applications for international clients, following industry best practices for code quality, performance, and maintainability. Contributed to client projects including DP World and Al-Nassar, gaining direct exposure to enterprise-scale development workflows and standards.",
		skills: ["Full-Stack Development", "React", "Node.js", "Enterprise-scale Projects"],
	},
	{
		id: 4,
		startDate: "Jul 2024",
		...
		location: "On-Site",
		description:
			"Developed scalable MERN-stack applications to support multiple client requirements. Performed website updates, UI improvements, and backend API development.",
		skills: ["MongoDB", "Express.js", "React", "Node.js", "UI Improvements", "API Development"],
	},
];

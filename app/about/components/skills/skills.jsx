...
const skillCategories = {
	web: {
		...
		tools: ["Git", "Docker", "Kubernetes", "Jira", "Responsive Web Design"],
	},
	api: {
		title: "REST API",
		icon: WebhookIcon,
		...
		tools: ["REST API design", "JWT/Auth", "Docker", "Kubernetes", "Git"],
	},
	ai: {
		title: "AI & Integrations",
		icon: ActivityIcon,
		description: "Integrating AI capabilities into production systems",
		languages: [
			"Python",
			"Gemini API",
			"Web Speech API",
